...
namespace OpenVinoSharp
{
    ...
    {
        private const string dll_extern = @"E:\Git_space\基于Csharp和OpenVINO部署PaddleOCR模型\src\Release\x64\OpenVinoSharpExtern.dll";
        ...
        [DllImport(dll_extern, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        public extern static void read_infer_result_F32(IntPtr core, string node_name, int size, ref float result);
